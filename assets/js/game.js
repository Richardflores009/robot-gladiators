var fightOrSkip = function () {
    ...
    if (promptFight === "skip") {
        ...
        if (confirmSkip) {
            ...
            // subtract money from playerMoney for skipping, but dont let it go in the negatives
...
var fight = function (enemy) {
    ...
    while (enemy.health > 0 && playerInfo.health > 0) {
        ...
        // genrate random damage value based value based on player's attack power
...
var shop = function () {
    ...
    var shopOptionPompt = window.prompt(
        "Would you like to REFILL your health, UPGRADE your attack, or LEAVE the store? Please enter one: 'REFILL', 'UPGRADE', or 'LEAVE' to make a choice"
    )
    // use switch to carry out action
    switch (shopOptionPompt) {
